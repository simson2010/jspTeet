...
public class MobileReplyServlet extends JTweetServlet
{
	static final Logger logger = Logger.getLogger(MobileReplyServlet.class.getName());
	String reply_id = "0";
	String with_quote = "0";
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
	{
		...
		reply_id = req.getParameter("id");
		long intReply_Id = Long.valueOf(reply_id);
	...
	protected void ReplyTo(HttpServletResponse resp) throws IOException
	{
		...
		try {
			...
			Template t = config.getTemplate("mreply.ftl");
